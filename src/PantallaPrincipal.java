...
public class PantallaPrincipal extends JFrame {
    ...
    //-----------------Proceso Consulta de Memorias Publicas (pide al servidor la lista y reconstruye las cards del feed)
    // ─── actualizarFeed ─────────────────
    ...
    private JPanel buildCrearPost() {
        ...
        //-----------------Proceso Alta de Memoria (sube imagen al servidor, luego envia datos de la memoria y actualiza el feed)
    ...
    //-----------------Proceso Seleccion y Carga de Imagen (FileChooser → lee como BufferedImage → guarda ruta para subirla al publicar)
    // ─── abrirSelectorImagen ─────────────────
