...
public class PantallaPerfil extends JFrame {
    ...
    private JPanel buildMenuDesplegable() {
        ...
        //-----------------Proceso Dar de Baja Memoria desde Perfil (activa modo seleccion, confirma y llama darDeBajaMemoria por cada seleccionada)
    ...
    //-----------------Proceso Consulta Memorias de Perfil (propio: publicas y privadas segun boton ojo; ajeno: solo publicas)
    // ─── refreshGrid ─────────────────
